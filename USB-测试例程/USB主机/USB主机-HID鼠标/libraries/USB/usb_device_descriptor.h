...
#define USB_DEVICE_CONFIGURATION_COUNT (1U)  //类的个数，比如z这里选择的是HID设备，该宏指定HID设备的个数
#define USB_DEVICE_STRING_COUNT (3U)
#define USB_DEVICE_LANGUAGE_COUNT (1U)

#define USB_HID_MOUSE_CONFIGURE_INDEX (1U)
#define USB_HID_MOUSE_INTERFACE_COUNT (1U)    //接口数量

#define USB_HID_MOUSE_IN_BUFFER_LENGTH (8U)
#define USB_HID_MOUSE_ENDPOINT_COUNT (1U)
#define USB_HID_MOUSE_INTERFACE_INDEX (0U)     //接口号
#define USB_HID_MOUSE_ENDPOINT_IN (1U)

#define USB_HID_MOUSE_CLASS (0x03U)     //类编号              已经确定了USB 类（HID,CDC）,精确到具体的HID设备的编号
#define USB_HID_MOUSE_SUBCLASS (0x01U)  //子类编号
#define USB_HID_MOUSE_PROTOCOL (0x02U)  //协议编号
