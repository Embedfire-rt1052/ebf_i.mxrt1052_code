...
///* 调试串口定义的信息 DEBUG_CONSOLE_DEVICE_TYPE_LPUART = 2*/
//#define BOARD_DEBUG_UART_TYPE         DEBUG_CONSOLE_DEVICE_TYPE_LPUART


/* The UART to use for debug messages. */
#define BOARD_DEBUG_UART_TYPE 2U
...
/* USB PHY condfiguration USB PHY设置*/
#define BOARD_USB_PHY_D_CAL (0x0CU)      //电流相关
#define BOARD_USB_PHY_TXCAL45DP (0x06U)  //设置USB-DP PHY 端接电阻为45欧姆    
#define BOARD_USB_PHY_TXCAL45DM (0x06U)  //设置USB-DM PHY 端接电阻为45欧姆
