...
/*********************************************************
 * UART6 GPIO端口、引脚号及IOMUXC复用宏定义
 
使用i.MX RT1052-Pro底板：
 *  TX-----GPIO_AD_B0_02,M11-----(CN5, 14)
 *  RX-----GPIO_AD_B0_03,G11-----(CN5, 16)
 *引脚功能         引脚标号     引脚在开发板上对应位置
 *TX引脚对应开发板CN5排针的第14脚(CN5, 14)
 *RX引脚对应开发板CN5排针的第16脚(CN5, 16)
 ...
 *引脚功能         引脚标号     引脚在开发板上对应位置
 *TX引脚对应开发板CN4排针的第14脚(CN4, 14)
 *RX引脚对应开发板CN4排针的第16脚(CN4, 16)
*********************************************************/
