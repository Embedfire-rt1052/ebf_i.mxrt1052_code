...
/*********************************************************
 * UART8 GPIO端口、引脚号及IOMUXC复用宏定义
 
使用i.MX RT1052-Pro底板：
 *  TX-----GPIO_AD_B1_10,L13-----(CN5, 31)
 *  RX-----GPIO_AD_B1_11,J13-----(CN5, 29)
 *引脚功能         引脚标号     引脚在开发板上对应位置
 *TX引脚对应开发板CN5排针的第31脚(CN5, 31)
 *RX引脚对应开发板CN5排针的第29脚(CN5, 29)

使用i.MX RT1052-Mini底板
 *  TX-----GPIO_AD_B1_10,L13-----(CN4, 31)
 *  RX-----GPIO_AD_B1_11,J13-----(CN4, 29)
 *引脚功能         引脚标号     引脚在开发板上对应位置
 *TX引脚对应开发板CN4排针的第31脚(CN4, 31)
 *RX引脚对应开发板CN4排针的第29脚(CN4, 29)
 
 
 *********************************************************/
#define UART_RX_GPIO                GPIO1
#define UART_RX_GPIO_PIN            (27U)
#define UART_RX_IOMUXC              IOMUXC_GPIO_AD_B1_11_LPUART8_RX

#define UART_TX_GPIO                GPIO1
#define UART_TX_GPIO_PIN            (26U)
#define UART_TX_IOMUXC              IOMUXC_GPIO_AD_B1_10_LPUART8_TX

/*******************************************************************************
 * UART8 串口号、中断服务函数、中断号重定义
 ******************************************************************************/

#define DEBUG_USARTx LPUART8
#define DEBUG_USART_IRQ LPUART8_IRQn
#define DEBUG_USART_IRQHandler LPUART8_IRQHandler


/*******************************************************************************
* UART8 串口配置参数定义，默认参数如下:
